...
return [
    ...
    */
    ...
    'confirmed' => ':attribute وارد شده با تکرار آن برابر نمی‌باشد.',
    ...
    */
    ...
    'custom' => [
        'image' => [
            ...
            'max' => 'حجم عکس ارسالی نباید بیشتر از 5 مگابایت باشد.'
        ],
        'cv' => [
            'required' => 'آپلود رزومه الزامی است.',
            'mimes' => 'فرمت رزومه باید یکی از دو نوع :values باشد.',
            'max' => 'حجم فایل ارسالی نباید بیشتر از 5 مگابایت باشد.'
